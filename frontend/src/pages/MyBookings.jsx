    ...
    <div className="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="space-y-8">
        ...
        {hotels.map((hotel) => (
          <motion.div
            key={hotel.id}
            className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] border border-gray-300 rounded-lg p-6 lg:p-8 gap-6 lg:gap-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out transform hover:scale-105 bg-white"
